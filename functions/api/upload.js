...
var BUCKET_NAME = "ghouthi";
var PUBLIC_URL = "https://pub-e354e3db406b475f95f0c08f1a94001e.r2.dev";
var BASE_URL = `https://${ACCOUNT_ID}.r2.cloudflarestorage.com`;
...
async function onRequestPost({ request }) {
  try {
    ...
    const fileName = customName ? `${customName}.${fileExt}` : `${Date.now()}_${file.name.replace(/[^a-zA-Z0-9.\-_]/g, "_")}`;
